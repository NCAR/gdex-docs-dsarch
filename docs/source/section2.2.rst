...
For Get-style actions (:ref:`-GD <GD>`, :ref:`-GV <GV>`, :ref:`-GG <GG>`, :ref:`-GS <GS>`, :ref:`-GW <GW>`, :ref:`-GH <GH>`, :ref:`-GQ <GQ>`), :ref:`Info options <section5>` are
interpreted as query filters. Four characters refine those filters; quote or
escape them on the command line so the shell does not consume them:
